                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="profile-img-edit position-relative">
                            <img src="/hopeui/html/assets/images/avatars/no_avatar.png" id="firstImage" alt="profile-pic"
                    ...
                    <div class="new-user-info">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select name="workLocation" class="selectpicker form-control" data-style="py-0"
                                    id="workLocation" disabled>
                                    <option selected disabled style="display:none !important" value="">Work Location
                                    </option>
                            ...
                            <div class="form-group col-sm-6" style="display: none;" id="outletAccess2">
                                <label class="form-label">Outlet Access:</label>
                                <select name="outletAccess" class="selectpicker form-control" data-style="py-0"
                                    id="outletAccess" multiple multiselect-select-all="true" multiselect-search="true"
