                            ...
                            <div class="modal-body">
                                <form action="">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationDefault01" required placeholder="input product cost">
                                        </div>
                                        <div class="col mb-3">
                                            <label class="form-label" for="validationDefault01">Brand Name *</label>
                                            <input type="text" class="form-control" id="validationDefault01" required placeholder="input product cost">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <input type="file" class="form-control" id="validationDefault01" required placeholder="input product cost">
                                        </div>
