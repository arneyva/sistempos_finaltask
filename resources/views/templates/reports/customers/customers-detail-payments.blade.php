...
@section('pages_title')
    <h1>{{ __('Customer') }} ~ {{ __('Payments') }} {{ __('Reports') }}</h1>
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div class="col-lg-12">
                                <div class="profile-content tab-content">
                                    <div id="adjustment" class="tab-pane fade active show">
                                        <div class="card-header d-flex justify-content-between">
                                            <form action="{{ route('reports.customers.payments', $client->id) }}"
                                                method="GET">
                                            ...
                                            <div class="header-title">
                                                <a href="{{ route('reports.customers.payments-export', ['search' => request('search'), 'id' => $client->id]) }}"
