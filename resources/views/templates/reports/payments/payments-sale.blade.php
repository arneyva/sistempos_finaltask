                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div class="card-body" style="background-color:bisque">
                                <ul class="d-flex nav nav-pills mb-0 text-center profile-tab" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#" role="tab" aria-selected="false">Sales
                                            Return</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="" role="tab" aria-selected="false">Purchase</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="" role="tab" aria-selected="false">Purchase
                                            Return</a>
                                    </li>
                                </ul>
                            </div>
