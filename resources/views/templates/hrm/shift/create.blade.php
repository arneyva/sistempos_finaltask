    ...
    <div class="card">
        ...
        @csrf
            ...
            <div class="tab-content">
                <div class="card-body tab-pane fade active show" id="days">
                    @php
                        $days = [
                            'monday' => 'monday',
                            'tuesday' => 'tuesday',
        ...
        <table id="selectedItemsTable" class="table table-borderless mt-5">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Email</th>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="card-body p-0 tab-pane fade" id="users">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#selectedItemsTable').on('click', '.btn-danger', function() {
                ...
                $('#itemDropdown').append(newOption).trigger('change');
                row.remove();
            });
        });
    </script>
