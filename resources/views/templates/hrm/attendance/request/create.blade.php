...
@section('pages_title')
<h1>Create Request Attendance</h1>
...
<style type="text/css">
    ...
    <form action="{{ route('hrm.request.store') }}" method="POST" class="row" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <h4 class="card-title">Create Request Attendance</h4>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="staffDropdown" class="form-control" name="attendance_id" style="width: 100%;height: 200%;" required>
                                        <option value=""></option>
                    ...
                    <div class="new-user-info">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" name="details" placeholder="Attendance Detail" required>{{ old('details')}}</textarea>
                                <small class=" text-danger font-italic">
                                    @error('details')
                                        {{ $message }}
                                    @enderror
