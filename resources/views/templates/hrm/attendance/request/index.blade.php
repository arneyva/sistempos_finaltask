                     ...
                     <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div class="d-flex flex-wrap align-items-center">
                           <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0 tab-content">
                              ...
                              <h4 class="me-2 h4" id="all-title">All Request</h4>
                           </div>
                        </div>
                  ...
                  <div class="card-body p-0 d-flex justify-content-between">
                    ...
                    <div class="header-title p-4 pt-3">
                        ...
                        <a href="#" style="margin-left: 30px;">
                            <a href="{{ route('hrm.request.create', 0) }}">
                    ...
                    <div  class="tab-content">
                        <div id="pending" class="card-body p-0 tab-pane fade active show">
                            <div  class="table-responsive mt-4">
                                    ...
                                    <tbody>
                                        ...
                                        @continue ($data->status == 2)
                                            <tr>
                                                ...
                                                @endrole
                                                    <td>{{$data->attendance->date->translatedFormat('d, F Y')}}</td>
                                                <td><span class="badge bg-warning">Pending</span></td>
                                                <td>{{ $data->admin->firstname ?? '-' }} {{ $data->admin->lastname ?? '' }}</td>
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        
                                                        <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="{{ route('hrm.request.edit', $data['id']) }}">
                                ...
                                <div class="bd-example" style="margin-left: 30px; margin-top:30px; margin-right:3   0px">
