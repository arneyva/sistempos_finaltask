...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="https://01f6-125-166-3-229.ngrok-free.app/hopeui/html/assets/images/favicon.ico">

    <!-- Library / Plugin Css Build -->
    <link rel="stylesheet" href="https://01f6-125-166-3-229.ngrok-free.app/hopeui/html/assets/css/core/libs.min.css">

    <!-- Aos Animation Css -->
    <link rel="stylesheet" href="https://01f6-125-166-3-229.ngrok-free.app/hopeui/html/assets/vendor/aos/dist/aos.css">

    <!-- Hope Ui Design System Css -->
    <link rel="stylesheet" href="https://01f6-125-166-3-229.ngrok-free.app/hopeui/html/assets/css/hope-ui.min.css?v=4.0.0">

    <!-- Custom Css -->
    <link rel="stylesheet" href="https://01f6-125-166-3-229.ngrok-free.app/hopeui/html/assets/css/custom.min.css?v=4.0.0">

    <!-- Dark Css -->
    <link rel="stylesheet" href="https://01f6-125-166-3-229.ngrok-free.app/hopeui/html/assets/css/dark.min.css">

    <!-- Customizer Css -->
    <link rel="stylesheet" href="https://01f6-125-166-3-229.ngrok-free.app/hopeui/html/assets/css/customizer.min.css">

    <!-- RTL Css -->
    <link rel="stylesheet" href="https://01f6-125-166-3-229.ngrok-free.app/hopeui/html/assets/css/rtl.min.css">
            ...
            <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group input-group-sm">
                                <span class="input-group-text" style='background-color: rgba(255, 255, 255, 0); border-color: transparent; font-weight: 500 !important; color:black;' id="basic-addon2">Rp</span>
                                <input type="tel" aria-describedby="basic-addon2" style="background-color: rgba(255, 255, 255, 0); border-color: transparent; font-weight: 500 !important; color:black;" class="form-control form-control-sm @error('date') is-invalid @enderror" id="change_return" disabled>
                            </div>
