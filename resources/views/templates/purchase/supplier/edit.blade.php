            ...
            <div class="row m-0 align-items-center bg-white vh-100">
                ...
                <!-- /.col -->
                                ...
                                <div class="new-user-info">
                                    <div class="row">
                                        ...
                                        <div class="form-group" style="display: none; align-items: center;" id="driver_phone">
                                            ...
                                            <div class="col-sm-9 p-0" style="float:right;">
                                                <input type="tel" value="{{ old('driver_phone') }}" class="form-control form-control-sm @error('date') is-invalid @enderror" id="input_driver_phone" name="driver_phone" >
                                        ...
                                        <div class="form-group" style="display: none; align-items: center;" id="shipment_number">
                                            ...
                                            <div class="col-sm-9 p-0" style="float:right;">
                                                <input type="tel" value="{{ old('shipment_number') }}" class="form-control form-control-sm @error('date') is-invalid @enderror" id="input_shipment_number" name="shipment_number" >
                                ...
                                <div class="new-user-info">
                                    <div class="row">
                                        ...
                                        <div class="form-group" style="display: none; align-items: center; " id="supplier_ewalet">
                                            ...
                                            <div class="col-sm-9 p-0" style="float:right;">
                                                <input type="tel" value="{{ old('supplier_ewalet') }}" class="form-control form-control-sm @error('date') is-invalid @enderror" id="input_ewalet" name="supplier_ewalet" >
                                        ...
                                        <div class="form-group" style="display: none; align-items: center;" id="supplier_bank_account">
                                            ...
                                            <div class="col-sm-9 p-0" style="float:right;">
                                                <input type="tel" value="{{ old('supplier_bank_account') }}" class="form-control form-control-sm @error('date') is-invalid @enderror" id="input_bank_account" name="supplier_bank_account">
                                ...
                                <div class="new-user-info">
                                    <div class="row">
                                        <div class="form-group" style="display: flex; align-items: center;">
                                            ...
                                            <div class="col-sm-9 p-0" style="float:right;">
                                                <input type="tel" value="{{ old('shipment_cost') }}" class="form-control form-control-sm @error('date') is-invalid @enderror" id="shipment_cost" name="shipment_cost" required>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <textarea class="form-control" id="supplier_notes" name="supplier_notes" required>{{ old('supplier_notes') }}</textarea> 
