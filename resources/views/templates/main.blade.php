            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('hopeui/html/assets/images/settings/dark/07.png') }}"
                                alt="rounded-all"
                                class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <img src="{{ asset('hopeui/html/assets/images/settings/light/07.png') }}"
                                alt="rounded-all"
                                class="mode light-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('hopeui/html/assets/images/settings/dark/08.png') }}"
                            ...
                            <img src="{{ asset('hopeui/html/assets/images/settings/light/09.png') }}"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 ">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('hopeui/html/assets/images/settings/dark/13.png') }}"
                            ...
                            <img src="{{ asset('hopeui/html/assets/images/settings/light/13.png') }}"
