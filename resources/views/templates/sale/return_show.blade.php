                        ...
                        <div>
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <p class="mb-0">{{ $sale_Return['client_name'] }}</p>
                                    <p class="mb-0">{{ $sale_Return['client_phone'] }}</p>
                                    <p class="mb-0">{{ $sale_Return['client_adr'] ?? 'Default' }}</p>
                                    <p class="mb-0">{{ $sale_Return['client_email'] }}</p>
                                </div>
                                <div class="col-md-4">
